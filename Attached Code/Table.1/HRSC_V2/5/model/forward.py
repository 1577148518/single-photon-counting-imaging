...
def forward(x,regularizer):
	...
	pixel1 = shift_ps(conv1,7,7)             # h*w等于采样次数
	print("pixel1",pixel1)
	
	recov_conv1_w = get_weight([7,7,1,1024],FLAGS.REGULARIZER)            #
	print("recov_conv1_w:",recov_conv1_w)
	recov_conv1_b = get_bias([1024])
	recov_conv1 = tf.nn.relu(tf.nn.conv2d(pixel1,recov_conv1_w,strides=[1,7,7,1], padding='VALID')+recov_conv1_b)    #
